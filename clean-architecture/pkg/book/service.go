...
type Service interface {
	...
	InsertBooks(book []*entities.Book) ([]*entities.Book, error)
...
func (s *service) InsertBooks(books []*entities.Book) ([]*entities.Book, error) {
	return s.repository.CreateBooks(books)
}
